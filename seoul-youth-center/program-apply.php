...
<main id="main" class="info-page program-apply-page">
    ...
    <?php else: ?>
        <form class="program-apply-form inner" action="<?= BASE_URL ?>/actions/application_create.php" method="post" autocomplete="off">
            ...
            <section class="program-apply-info" aria-labelledby="program-info-title">
                ...
                <div class="program-apply-fields type-label">
                    <label class="program-apply-field">
                        ...
                        <input class="control" type="text" name="applicant_name" autocomplete="name" placeholder="신청자명을 입력하세요" required>
                    </label>
                    <label class="program-apply-field">
                        <span>생년월일 <strong>*</strong></span>
                        <input class="control" type="text" name="birthdate" placeholder="생년월일 8자리를 입력하세요" inputmode="numeric" autocomplete="bday" required>
                    </label>
                    <label class="program-apply-field">
                    ...
                    <label class="program-apply-field">
                        ...
                        <input class="control" type="password" name="password" placeholder="4자 이상 입력하세요" minlength="4" autocomplete="new-password" required>
                    </label>
                    <label class="program-apply-field">
                        <span>비밀번호 확인 <strong>*</strong></span>
                        <input class="control" type="password" name="password_confirm" placeholder="비밀번호를 다시 입력하세요" minlength="4" autocomplete="new-password" required>
                    </label>
                    <label class="program-apply-field">
                        <span>휴대전화 <strong>*</strong></span>
                        <input class="control" type="tel" name="phone" placeholder="숫자만 입력하세요" inputmode="numeric" autocomplete="tel" required>
                    </label>
                    <label class="program-apply-field">
                        <span>이메일</span>
                        <input class="control" type="email" name="email" autocomplete="email" placeholder="이메일을 입력하세요">
                    </label>
                    <label class="program-apply-field">
                        <span>주소</span>
                        <input class="control" type="text" name="address" placeholder="주소를 입력하세요" autocomplete="street-address">
                    </label>
                    <label class="program-apply-field">
                        <span>학교명</span>
                        <input class="control" type="text" name="school" placeholder="학교명을 입력하세요">
                    </label>
                </div>
            </section>
