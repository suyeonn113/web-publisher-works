<div class="program-confirm-modal" data-program-confirm-modal hidden>
    ...
    >
        ...
        <div class="program-confirm-modal__header">
            <p class="type-body-lg">신청확인</p>
            <h2 class="type-section-title" id="program-confirm-title">프로그램 신청 정보를 입력해주세요.</h2>
            <span class="type-label" data-program-confirm-name>선택한 프로그램</span>
        </div>
        <form class="program-confirm-modal__form type-label" action="<?= BASE_URL ?>/actions/application_confirm.php" method="post" autocomplete="off">
            ...
            <p class="program-confirm-modal__help type-label">등록한 정보 확인이 어려우면 센터로 문의해주세요.</p>
            <div class="program-confirm-modal__actions">
                <button class="program-confirm-modal__submit control control--primary" type="submit">확인</button>
                <button class="program-confirm-modal__cancel control" type="button" data-program-confirm-close>닫기</button>
            </div>
        </form>
    </section>
</div>
